...
function submit() {
  form.post(route('admin.jadwal-turne.update', props.jadwalTurne.id), {
    _method: 'patch',
    preserveScroll: true,
  })
}
    ...
    <div class="py-6 max-w-3xl mx-auto bg-white p-6 rounded shadow space-y-6">
      <form @submit.prevent="submit" class="space-y-4">
        <div>
          ...
          <input v-model="form.lokasi" type="text" class="mt-1 block w-full border-gray-300 rounded" />
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input v-model="form.hari" type="text" class="mt-1 block w-full border-gray-300 rounded" />
