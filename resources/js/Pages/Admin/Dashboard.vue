  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12 max-w-7xl mx-auto px-4 space-y-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        />
        <StatCard
          label="Total Umat di seluruh Stasi"
          :value="totalUmat"
          :icon="UsersIcon"
        />
      </div>
        ...
        <div class="overflow-x-auto bg-white shadow rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr
                v-for="(jadwal, idx) in currentMonthSchedules"
                :key="jadwal.id"
              >
                ...
                <td class="px-4 py-2">
                  <Link
                    :href="route('admin.jadwal-turne.show', jadwal.id)"
...
import { UsersIcon, BuildingLibraryIcon } from '@heroicons/vue/24/solid'

// Ambil props yang dikirim DashboardController
const { jumlahStasi, totalUmat, currentMonthSchedules } = usePage().props
</script>
